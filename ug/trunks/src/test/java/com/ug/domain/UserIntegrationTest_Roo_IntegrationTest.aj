...
privileged aspect UserIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserIntegrationTest.testCountUsers() {
        ...
        long count = com.ug.domain.User.countUsers();
    ...
    public void UserIntegrationTest.testFindUser() {
        com.ug.domain.User obj = dod.getRandomUser();
        ...
        obj = com.ug.domain.User.findUser(id);
    ...
    public void UserIntegrationTest.testFindAllUsers() {
        ...
        java.util.List<com.ug.domain.User> result = com.ug.domain.User.findAllUsers();
    ...
    public void UserIntegrationTest.testFindUserEntries() {
        ...
        java.util.List<com.ug.domain.User> result = com.ug.domain.User.findUserEntries(0, (int) count);
    ...
    public void UserIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyUser(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.ug.domain.User merged = (com.ug.domain.User) obj.merge();
        obj.flush();
    ...
    public void UserIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'User' failed to initialize correctly", dod.getRandomUser());
        com.ug.domain.User obj = dod.getNewTransientUser(Integer.MAX_VALUE);
    ...
    public void UserIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'User' with identifier '" + id + "'", com.ug.domain.User.findUser(id));
    }
