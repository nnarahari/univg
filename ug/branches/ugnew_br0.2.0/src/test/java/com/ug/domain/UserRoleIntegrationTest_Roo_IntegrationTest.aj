...
import com.ug.domain.UserRoleDataOnDemand;
...
privileged aspect UserRoleIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserRoleIntegrationTest.testCountUserRoles() {
        ...
        long count = com.ug.domain.UserRole.countUserRoles();
    ...
    public void UserRoleIntegrationTest.testFindUserRole() {
        com.ug.domain.UserRole obj = dod.getRandomUserRole();
        ...
        obj = com.ug.domain.UserRole.findUserRole(id);
    ...
    public void UserRoleIntegrationTest.testFindAllUserRoles() {
        ...
        java.util.List<com.ug.domain.UserRole> result = com.ug.domain.UserRole.findAllUserRoles();
    ...
    public void UserRoleIntegrationTest.testFindUserRoleEntries() {
        ...
        java.util.List<com.ug.domain.UserRole> result = com.ug.domain.UserRole.findUserRoleEntries(0, (int) count);
    ...
    public void UserRoleIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyUserRole(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.ug.domain.UserRole merged = (com.ug.domain.UserRole) obj.merge();
        obj.flush();
    ...
    public void UserRoleIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'UserRole' failed to initialize correctly", dod.getRandomUserRole());
        com.ug.domain.UserRole obj = dod.getNewTransientUserRole(Integer.MAX_VALUE);
    ...
    public void UserRoleIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'UserRole' with identifier '" + id + "'", com.ug.domain.UserRole.findUserRole(id));
    }
