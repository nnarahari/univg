...
privileged aspect Loan_Roo_DbManaged {
    ...
    @Column(name = "loan_origin_date", columnDefinition = "DATETIME")
    @Temporal(TemporalType.TIMESTAMP)
    @DateTimeFormat(style = "S-")
    private Date Loan.loanOriginDate;
    ...
    @Column(name = "first_payment_date", columnDefinition = "DATETIME")
    @Temporal(TemporalType.TIMESTAMP)
    @DateTimeFormat(style = "S-")
    private Date Loan.firstPaymentDate;
    
    @Column(name = "last_payment_date", columnDefinition = "DATETIME")
    @Temporal(TemporalType.TIMESTAMP)
    @DateTimeFormat(style = "S-")
    private Date Loan.lastPaymentDate;
